		...
		<div class="card-body mt-2">
			...
			<div class="field-container mt-4">
				<form action="" method="POST">
						...
						<div class="col">
							<div class="form-group mb-3">
								<input class="dv-input-bottom w-100 pb-2" type="text" class="form-control"
									id="firstName" placeholder="Enter First Name" name="first_name" required
					...
					<div class="g-recaptcha" data-sitekey="6LcyOL0UAAAAABwvXc29QOqicmN6_co2SR0iaupS"></div>
					<button type="submit"
						class="btn text-white dv-bg-primary w-100 my-3 bt-dv-bg-primary">Register</button>
